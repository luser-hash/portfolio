...
const getSubmissionError = (error) => {
  ...
  if (error?.response?.status === 429) {
    return {
      message: "Too many messages were sent from this network. Please wait a while and try again.",
      fieldErrors,
    };
  }
  ...
  if (responseData && typeof responseData === "object" && !Array.isArray(responseData)) {
    Object.entries(responseData).forEach(([field, value]) => {
      if (!Array.isArray(value) || !(field in initialFormData)) {
        return;
      }

      fieldErrors[field] = value.map((item) => String(item)).join(" ");
    });

    if (Array.isArray(responseData.non_field_errors) && responseData.non_field_errors.length > 0) {
      return {
        message: responseData.non_field_errors.map((item) => String(item)).join(" "),
        fieldErrors,
      };
    }
...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { message, fieldErrors } = getSubmissionError(error);
      ...
      <div className="site-page-shell">
        <div className="contact-wrapper">
          ...
          <div className="contact-channels">
            <a href={gmailComposeUrl} target="_blank" rel="noreferrer" className="contact-channel">
              ...
              <div>
                ...
                <p className="contact-channel-value">{emailAddress}</p>
              </div>
            </a>

            <a href="https://github.com/luser-hash" target="_blank" rel="noreferrer" className="contact-channel">
              <span className="contact-channel-icon">
              ...
              <div>
                ...
                <p className="contact-channel-value">https://github.com/luser-hash</p>
              </div>
            </a>
            ...
            <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="contact-channel">
              ...
              <div>
                ...
                <p className="contact-channel-value">www.linkedin.com/in/md-amiluzzaman-nafis</p>
              </div>
            </a>
          </div>
          </div>
              ...
              <form onSubmit={handleSubmit} className="contact-form">
                ...
                <div className="form-row">
                  <div className="form-group">
                    ...
                    <input
                      ...
                      required
                    />
                    {formErrors.name ? <p className="form-error-text">{formErrors.name}</p> : null}
                  </div>
                  <div className="form-group">
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    required
                  />
                  {formErrors.subject ? <p className="form-error-text">{formErrors.subject}</p> : null}
                </div>
                ...
                <div className="form-group">
                  ...
                  <textarea
                    ...
                    required
                  />
                  {formErrors.message ? <p className="form-error-text">{formErrors.message}</p> : null}
                </div>
